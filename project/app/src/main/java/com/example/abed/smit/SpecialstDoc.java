...
public class  SpecialstDoc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specialst_doc);
        ...
        specialist=getResources().getStringArray(R.array.Speciality);
        spinner=(Spinner)findViewById(R.id.speciality);
        ArrayAdapter<String> adapter2=new ArrayAdapter<String>(this,R.layout.speciality,R.id.textView_Spinner_speciality,specialist);
        ...
        SearchButton_doc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String searchBoxInput1 = spinner.getSelectedItem().toString();
    ...
    private void SearchDoc(String searchBoxInput1) {
        ...
        Query searchdoctorquery = allDocdatabaseref.orderByChild("specialist").startAt(searchBoxInput1).endAt(searchBoxInput1 + "\uf8ff");
