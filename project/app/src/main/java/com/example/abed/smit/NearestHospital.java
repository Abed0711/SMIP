...
public class NearestHospital extends FragmentActivity implements OnMapReadyCallback {
    ...
    private  GPSTreacker gpsTreacker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nearest_hospital3);
        gpsTreacker=new GPSTreacker(getApplicationContext());
        mLocation=gpsTreacker.getLocation();
